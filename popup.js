...
async function injectOntoHome() {
	...
	for (let i = 0; i < campaignKeys.length; i++) {
		...
		cancelDeleteImage.setAttribute("src", "assets/close button.png");
		...
		confirmDeleteImage.setAttribute("src", "assets/check.png");
...
async function addLeadsToCampaignData(campaignName, newData) {
	...
	campaignStorage.Campaigns[campaignName].scrapedData = [...newData, ...existingData];
